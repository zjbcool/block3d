...
MenuGenerator.Texture = new DropdownHelper([
  ['anisotropicFilteringLevel', 'anisotropicFilteringLevel', 'NUM', '4', 'With compliant hardware and browser (supporting anisotropic filtering)\nthis defines the level of anisotropic filtering in the texture.\nThe higher the better but the slower. This defaults to 4 as it seems to be the best tradeoff.'],
  ['hasAlpha', 'hasAlpha', 'BOOL', 'FALSE', 'Define if the texture is having a usable alpha value (can be use for transparency or glossiness for instance).'],
  ['invertY', 'invertY', 'BOOL', 'FALSE', 'Gets a boolean indicating if the texture needs to be inverted on the y axis during loading'],
  ['invertZ', 'invertZ', 'BOOL', 'FALSE', 'Is Z inverted in the texture (useful in a cube texture).'],
  ['level', 'level', 'NUM', '1', 'Intensity or strength of the texture.It is commonly used by materials to fine tune the intensity of the texture'],
  ['uAng', 'uAng', 'NUM', '0', 'Define an offset on the texture to rotate around the u coordinates of the UVs\nThe angle is defined in radians.'],
  ['uOffset', 'uOffset', 'NUM', '0', 'Define an offset on the texture to offset the u coordinates of the UVs'],
  ['uRotationCenter', 'uRotationCenter', 'NUM', '0', 'Defines the center of rotation (U)'],
  ['uScale', 'uScale', 'NUM', '1', 'Define an offset on the texture to scale the u coordinates of the UVs'],
  ['url', 'url', 'TEXT', '', 'Define the url of the texture.'],
  ['vAng', 'vAng', 'NUM', '0', 'Define an offset on the texture to rotate around the v coordinates of the UVs\nThe angle is defined in radians.'],
  ['vOffset', 'vOffset', 'NUM', '0', 'Define an offset on the texture to offset the v coordinates of the UVs'],
  ['vRotationCenter', 'vRotationCenter', 'NUM', '0', 'Defines the center of rotation (V)'],
  ['vScale', 'vScale', 'NUM', '1', 'Define an offset on the texture to scale the v coordinates of the UVs'],
  ['wAng', 'wAng', 'NUM', '0', 'Define an offset on the texture to rotate around the w coordinates of the UVs (in case of 3d texture)\nThe angle is defined in radians.'],
  ['wRotationCenter', 'wRotationCenter', 'NUM', '0', 'Defines the center of rotation (W)'],
  ['wrapR', 'wrapR', 'NUM', '0', '0-CLAMP_ADDRESSMODE\n1-WRAP_ADDRESSMODE\n2-MIRROR_ADDRESSMODE'],
])

MenuGenerator.CubeTexture = new DropdownHelper([
  ['anisotropicFilteringLevel', 'anisotropicFilteringLevel', 'NUM', '4', 'With compliant hardware and browser (supporting anisotropic filtering)\nthis defines the level of anisotropic filtering in the texture.\nThe higher the better but the slower. This defaults to 4 as it seems to be the best tradeoff.'],
  ['coordinatesMode', 'coordinatesMode', 'NUM', '0', 'How a texture is mapped. \n0-EXPLICIT_MODE\n1-SPHERICAL_MODE\n2-PLANAR_MODE\n3-CUBIC_MODE\n4-PROJECTION_MODE\n5-SKYBOX_MODE\n6-INVCUBIC_MODE\n7-EQUIRECTANGULAR_MODE\n8-FIXED_EQUIRECTANGULAR_MODE\n9-FIXED_EQUIRECTANGULAR_MIRRORED_MODE'],
  ['hasAlpha', 'hasAlpha', 'BOOL', 'FALSE', 'Define if the texture is having a usable alpha value (can be use for transparency or glossiness for instance).'],
  ['invertZ', 'invertZ', 'BOOL', 'FALSE', 'Is Z inverted in the texture (useful in a cube texture).'],
  ['level', 'level', 'NUM', '1', 'Intensity or strength of the texture.It is commonly used by materials to fine tune the intensity of the texture'],
  ['url', 'url', 'TEXT', '', 'Define the url of the texture.'],
  ['rotationY', 'rotationY', 'NUM', '', 'Sets or gets texture matrix rotation angle around Y axis in radians. '],
  ['wrapU', 'wrapU', 'NUM', '', '0-CLAMP_ADDRESSMODE\n1-WRAP_ADDRESSMODE\n2-MIRROR_ADDRESSMODE'],
  ['wrapV', 'wrapV', 'NUM', '', '0-CLAMP_ADDRESSMODE\n1-WRAP_ADDRESSMODE\n2-MIRROR_ADDRESSMODE'],
