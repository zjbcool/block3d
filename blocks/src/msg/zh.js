 ...
 */
// 公用
const LISTS_INLIST = 'in array';
const CONTROLS_REPEAT_INPUT_DO = 'do';
const CONTROLS_IF_MSG_IF = 'if';
const CONTROLS_IF_MSG_ELSEIF = 'else if';
const CONTROLS_IF_MSG_ELSE = 'else';
const VARIABLES_DEFAULT_NAME = 'item';
const LISTS_INDEX_OF_HELPURL = 'https://github.com/google/blockly/wiki/Lists#getting-items-from-a-list';
const PROCEDURES_DEFNORETURN_TITLE = 'to';
const PROCEDURES_DEFNORETURN_PROCEDURE = 'do something';
const PROCEDURES_DEFNORETURN_DO = '';
const PROCEDURES_DEFNORETURN_COMMENT = 'Describe this function...';
...
export default {
  ...
  /// context menu - 跳转至execute_tab对应的选项卡
  GO_TO_TAB: '跳转选项卡',

  /// context menu - 打印拼图名称
  PRINT_BLOCK_NAME: '打印拼图名称',
  ...
  RENAME_VARIABLE_TITLE: '重命名所有变量 "%1" 为:',
  ...
  CONTROLS_FOREACH_TITLE: 'for each item %1 in array %2',
  ...
  CONTROLS_FOREACH_TOOLTIP: 'For each item in a array, set the variable "%1" to the item, and then do some statements.',
  ...
  MATH_ONLIST_OPERATOR_AVERAGE: 'average of array',

  /// tooltip - See [https://en.wikipedia.org/wiki/Arithmetic_mean https://en.wikipedia.org/wiki/Arithmetic_mean] for more informatin.
  MATH_ONLIST_TOOLTIP_AVERAGE: 'Return the average (arithmetic mean) of the numeric values in the array.',
  ...
  MATH_ONLIST_OPERATOR_MODE: 'modes of array',
  ...
  MATH_ONLIST_TOOLTIP_MODE: 'Return an array of the most common item(s) in the list.',
  ...
  MATH_ONLIST_TOOLTIP_STD_DEV: 'Return the standard deviation of the array.',

  /// dropdown - This choose an element at random from a list.  Each element is chosen with equal probability.
  MATH_ONLIST_OPERATOR_RANDOM: 'random item of array',

  /// tooltip - Please use same term for 'random' as in previous entry.
  MATH_ONLIST_TOOLTIP_RANDOM: 'Return a random element from the array.',
  ...
  LISTS_CREATE_EMPTY_TITLE: 'create empty array',

  /// block text - See [https://github.com/google/blockly/wiki/Lists#create-empty-list https://github.com/google/blockly/wiki/Lists#create-empty-list].
  LISTS_CREATE_EMPTY_TOOLTIP: 'Returns a array, of length 0, containing no data records',
  ...
  LISTS_CREATE_WITH_TOOLTIP: 'Create a array with any number of items.',
  ...
  LISTS_CREATE_WITH_INPUT_WITH: 'create array with',
  ...
  LISTS_CREATE_WITH_CONTAINER_TITLE_ADD: 'array',
  ...
  /// tooltip - See [https://github.com/google/blockly/wiki/Lists#changing-number-of-inputs https://github.com/google/blockly/wiki/Lists#changing-number-of-inputs].
  LISTS_CREATE_WITH_ITEM_TOOLTIP: 'Add an item to the array.',
  ...
  LISTS_REPEAT_TOOLTIP: 'Creates a array consisting of the given value repeated the specified number of times.',
  ...
  LISTS_REPEAT_TITLE: 'create array with item %1 repeated %2 times',
  ...
  LISTS_LENGTH_TOOLTIP: 'Returns the length of a array.',
  ...
  /// https://github.com/google/blockly/wiki/Lists#is-empty].
  LISTS_ISEMPTY_TOOLTIP: 'Returns true if the array is empty.',
  ...
  VARIABLES_GET_CREATE_SET: '创建 "set %1"',
  ...
  /// this variable.\n\nParameters:\n* %1 - the name of the variable.
  VARIABLES_SET_CREATE_GET: '创建 "get %1"',
