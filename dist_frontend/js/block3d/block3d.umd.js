...
<div class="dialog-bg" id="publishDialog">
  <div class="dialog">
    ...
    `]),d(Ue,"properties",{lang:{}}),customElements.define("publish-dialog",Ue);class Je extends v{constructor(){super();d(this,"submitActiveCode",n=>{n.preventDefault(),this.onactive&&this.onactive()});d(this,"submitInactiveCode",n=>{n.preventDefault(),this.oninactive&&this.oninactive()});d(this,"_onclose",n=>{n.key==="Escape"&&this.close()});this.lang="zh",this.status="ACTIVE",this.expires=0,this.leftdays=0}render(){const n=this,a={};a.header=n.lang==="zh"?"\u6FC0\u6D3B\u7801":"Active Key",a.activeTitle=n.lang==="zh"?"\u8F93\u5165\u6FC0\u6D3B\u7801\uFF0C\u53BB\u9664\u5E7F\u544A":"Enter your active key to remove the ads",a.inactiveTitle=n.lang==="zh"?"\u5DF2\u6FC0\u6D3B\uFF01\u6709\u6548\u671F\u622A\u81F3":"Actived! valid until ",a.activeButton=n.lang==="zh"?"\u6FC0\u6D3B":"Active",a.inactiveButton=n.lang==="zh"?"\u53D6\u6D88\u6FC0\u6D3B":"Inactive",a.activeExpiresTitle=n.lang==="zh"?"\u5DF2\u8FC7\u671F\uFF01\u6709\u6548\u671F\u622A\u81F3":"Expired! valid until ";let s,r;return this.lang==="zh"?r=E`
...
<div class="dialog-bg d-flex">
  ...
  `]),d(Ge,"properties",{name:{},lang:{},dropdownShown:{},leftdays:{}}),customElements.define("editor-menu",Ge);class He extends v{constructor(){super();d(this,"_playback",()=>{this.playback&&this.playback()});this.info="",this.fps="",this.running=!0,this.lang="zh"}getYear(){return new Date().getFullYear()}render(){const n=this.lang==="zh"?`\u7248\u6743\u6240\u6709\xA9 2022-${this.getYear()} \u5B85\u5BB6\u5457`:`Copyright \xA9 2022-${this.getYear()} zjbku`;return E`
  ...
  .show {
    visibility: visible;
  }`),d($e,"properties",{workspace:{},options:{state:!0},isVisible:{},currIndex:{},selectedBlock:{}}),customElements.define("search-block",$e);class Ct extends v{render(){return E`
  ...
  `),customElements.define("editor-aside",Rt);function w(i){return document.createElement(i)}function tn(i,t){i=typeof i=="string"?document.getElementById("root"):i;const{TITLE:n,PROJECT_NAME:a,LANG:s,PROJECTS_LIST:r,LICENSE_STATUS:p,LICENSE_LEFT_DAYS:c,EXPIRES:l,APP_HOST:u,APP_PORT:M,PROJECTS_FOLDER:m,AUTO_OPEN:_,AUTO_SAVE:I,EXTERNAL_SERVER:Y,VERSION:k,RELEASE_DATE:Xa}=t,V=document.body,oe=w("div");oe.className="editor-container",i.appendChild(oe);const pe=w("editor-menu");pe.id="menu",pe.lang=s,pe.name=n,pe.leftdays=c,oe.appendChild(pe);const Ai=w("main");Ai.innerHTML=`
...
function ${e.JavaScript.FUNCTION_NAME_PLACEHOLDER_}(option, point_option, normal_option){ 
  ...
  ${t}.moveToVector3(${n}, appInstance.scene);`:""};const ai=`
  // common function
