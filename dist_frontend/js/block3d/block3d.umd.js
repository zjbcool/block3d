(function(T,e){typeof exports=="object"&&typeof module<"u"?e(exports,require("blockly")):typeof define=="function"&&define.amd?define(["exports","blockly"],e):(T=typeof globalThis<"u"?globalThis:T||self,e(T.block3d={},T.Blockly))})(this,function(T,e){"use strict";var qa=Object.defineProperty,Ba=Object.defineProperties;var es=Object.getOwnPropertyDescriptors;var Li=Object.getOwnPropertySymbols;var ts=Object.prototype.hasOwnProperty,is=Object.prototype.propertyIsEnumerable;var ot=(T,e,f)=>e in T?qa(T,e,{enumerable:!0,configurable:!0,writable:!0,value:f}):T[e]=f,wi=(T,e)=>{for(var f in e||(e={}))ts.call(e,f)&&ot(T,f,e[f]);if(Li)for(var f of Li(e))is.call(e,f)&&ot(T,f,e[f]);return T},xi=(T,e)=>Ba(T,es(e));var d=(T,e,f)=>(ot(T,typeof e!="symbol"?e+"":e,f),f);const j=(i=>i&&typeof i=="object"&&"default"in i?i:{default:i})(e);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ce=Symbol(),pt=new Map;class ct{constructor(t,n){if(this._$cssResult$=!0,n!==Ce)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let t=pt.get(this.cssText);return fe&&t===void 0&&(pt.set(this.cssText,t=new CSSStyleSheet),t.replaceSync(this.cssText)),t}toString(){return this.cssText}}const zi=i=>new ct(typeof i=="string"?i:i+"",Ce),C=(i,...t)=>{const n=i.length===1?i[0]:t.reduce((a,s,r)=>a+(p=>{if(p._$cssResult$===!0)return p.cssText;if(typeof p=="number")return p;throw Error("Value passed to 'css' function must be a 'css' function result: "+p+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+i[r+1],i[0]);return new ct(n,Ce)},Fi=(i,t)=>{fe?i.adoptedStyleSheets=t.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet):t.forEach(n=>{const a=document.createElement("style"),s=window.litNonce;s!==void 0&&a.setAttribute("nonce",s),a.textContent=n.cssText,i.appendChild(a)})},dt=fe?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let n="";for(const a of t.cssRules)n+=a.cssText;return zi(n)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Re;const lt=window.trustedTypes,ji=lt?lt.emptyScript:"",ut=window.reactiveElementPolyfillSupport,De={toAttribute(i,t){switch(t){case Boolean:i=i?ji:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,t){let n=i;switch(t){case Boolean:n=i!==null;break;case Number:n=i===null?null:Number(i);break;case Object:case Array:try{n=JSON.parse(i)}catch{n=null}}return n}},ht=(i,t)=>t!==i&&(t==t||i==i),Le={attribute:!0,type:String,converter:De,reflect:!1,hasChanged:ht};class Q extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var n;(n=this.l)!==null&&n!==void 0||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach((n,a)=>{const s=this._$Eh(a,n);s!==void 0&&(this._$Eu.set(s,a),t.push(s))}),t}static createProperty(t,n=Le){if(n.state&&(n.attribute=!1),this.finalize(),this.elementProperties.set(t,n),!n.noAccessor&&!this.prototype.hasOwnProperty(t)){const a=typeof t=="symbol"?Symbol():"__"+t,s=this.getPropertyDescriptor(t,a,n);s!==void 0&&Object.defineProperty(this.prototype,t,s)}}static getPropertyDescriptor(t,n,a){return{get(){return this[n]},set(s){const r=this[t];this[n]=s,this.requestUpdate(t,r,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||Le}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const n=this.properties,a=[...Object.getOwnPropertyNames(n),...Object.getOwnPropertySymbols(n)];for(const s of a)this.createProperty(s,n[s])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const n=[];if(Array.isArray(t)){const a=new Set(t.flat(1/0).reverse());for(const s of a)n.unshift(dt(s))}else t!==void 0&&n.push(dt(t));return n}static _$Eh(t,n){const a=n.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}o(){var t;this._$Ep=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$Em(),this.requestUpdate(),(t=this.constructor.l)===null||t===void 0||t.forEach(n=>n(this))}addController(t){var n,a;((n=this._$Eg)!==null&&n!==void 0?n:this._$Eg=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((a=t.hostConnected)===null||a===void 0||a.call(t))}removeController(t){var n;(n=this._$Eg)===null||n===void 0||n.splice(this._$Eg.indexOf(t)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((t,n)=>{this.hasOwnProperty(n)&&(this._$Et.set(n,this[n]),delete this[n])})}createRenderRoot(){var t;const n=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return Fi(n,this.constructor.elementStyles),n}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$Eg)===null||t===void 0||t.forEach(n=>{var a;return(a=n.hostConnected)===null||a===void 0?void 0:a.call(n)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$Eg)===null||t===void 0||t.forEach(n=>{var a;return(a=n.hostDisconnected)===null||a===void 0?void 0:a.call(n)})}attributeChangedCallback(t,n,a){this._$AK(t,a)}_$ES(t,n,a=Le){var s,r;const p=this.constructor._$Eh(t,a);if(p!==void 0&&a.reflect===!0){const c=((r=(s=a.converter)===null||s===void 0?void 0:s.toAttribute)!==null&&r!==void 0?r:De.toAttribute)(n,a.type);this._$Ei=t,c==null?this.removeAttribute(p):this.setAttribute(p,c),this._$Ei=null}}_$AK(t,n){var a,s,r;const p=this.constructor,c=p._$Eu.get(t);if(c!==void 0&&this._$Ei!==c){const l=p.getPropertyOptions(c),u=l.converter,M=(r=(s=(a=u)===null||a===void 0?void 0:a.fromAttribute)!==null&&s!==void 0?s:typeof u=="function"?u:null)!==null&&r!==void 0?r:De.fromAttribute;this._$Ei=c,this[c]=M(n,l.type),this._$Ei=null}}requestUpdate(t,n,a){let s=!0;t!==void 0&&(((a=a||this.constructor.getPropertyOptions(t)).hasChanged||ht)(this[t],n)?(this._$AL.has(t)||this._$AL.set(t,n),a.reflect===!0&&this._$Ei!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,a))):s=!1),!this.isUpdatePending&&s&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(n){Promise.reject(n)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((s,r)=>this[r]=s),this._$Et=void 0);let n=!1;const a=this._$AL;try{n=this.shouldUpdate(a),n?(this.willUpdate(a),(t=this._$Eg)===null||t===void 0||t.forEach(s=>{var r;return(r=s.hostUpdate)===null||r===void 0?void 0:r.call(s)}),this.update(a)):this._$EU()}catch(s){throw n=!1,this._$EU(),s}n&&this._$AE(a)}willUpdate(t){}_$AE(t){var n;(n=this._$Eg)===null||n===void 0||n.forEach(a=>{var s;return(s=a.hostUpdated)===null||s===void 0?void 0:s.call(a)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((n,a)=>this._$ES(a,this[a],n)),this._$EC=void 0),this._$EU()}updated(t){}firstUpdated(t){}}Q.finalized=!0,Q.elementProperties=new Map,Q.elementStyles=[],Q.shadowRootOptions={mode:"open"},ut==null||ut({ReactiveElement:Q}),((Re=globalThis.reactiveElementVersions)!==null&&Re!==void 0?Re:globalThis.reactiveElementVersions=[]).push("1.3.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var we;const X=globalThis.trustedTypes,mt=X?X.createPolicy("lit-html",{createHTML:i=>i}):void 0,P=`lit$${(Math.random()+"").slice(9)}$`,gt="?"+P,yi=`<${gt}>`,W=document,te=(i="")=>W.createComment(i),ie=i=>i===null||typeof i!="object"&&typeof i!="function",_t=Array.isArray,Ui=i=>{var t;return _t(i)||typeof((t=i)===null||t===void 0?void 0:t[Symbol.iterator])=="function"},ne=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Tt=/-->/g,Et=/>/g,G=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Nt=/'/g,Mt=/"/g,It=/^(?:script|style|textarea|title)$/i,Ji=i=>(t,...n)=>({_$litType$:i,strings:t,values:n}),E=Ji(1),K=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),vt=new WeakMap,Pi=(i,t,n)=>{var a,s;const r=(a=n==null?void 0:n.renderBefore)!==null&&a!==void 0?a:t;let p=r._$litPart$;if(p===void 0){const c=(s=n==null?void 0:n.renderBefore)!==null&&s!==void 0?s:null;r._$litPart$=p=new se(t.insertBefore(te(),c),c,void 0,n!=null?n:{})}return p._$AI(i),p},Z=W.createTreeWalker(W,129,null,!1),Yi=(i,t)=>{const n=i.length-1,a=[];let s,r=t===2?"<svg>":"",p=ne;for(let l=0;l<n;l++){const u=i[l];let M,m,_=-1,I=0;for(;I<u.length&&(p.lastIndex=I,m=p.exec(u),m!==null);)I=p.lastIndex,p===ne?m[1]==="!--"?p=Tt:m[1]!==void 0?p=Et:m[2]!==void 0?(It.test(m[2])&&(s=RegExp("</"+m[2],"g")),p=G):m[3]!==void 0&&(p=G):p===G?m[0]===">"?(p=s!=null?s:ne,_=-1):m[1]===void 0?_=-2:(_=p.lastIndex-m[2].length,M=m[1],p=m[3]===void 0?G:m[3]==='"'?Mt:Nt):p===Mt||p===Nt?p=G:p===Tt||p===Et?p=ne:(p=G,s=void 0);const Y=p===G&&i[l+1].startsWith("/>")?" ":"";r+=p===ne?u+yi:_>=0?(a.push(M),u.slice(0,_)+"$lit$"+u.slice(_)+P+Y):u+P+(_===-2?(a.push(void 0),l):Y)}const c=r+(i[n]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[mt!==void 0?mt.createHTML(c):c,a]};class ae{constructor({strings:t,_$litType$:n},a){let s;this.parts=[];let r=0,p=0;const c=t.length-1,l=this.parts,[u,M]=Yi(t,n);if(this.el=ae.createElement(u,a),Z.currentNode=this.el.content,n===2){const m=this.el.content,_=m.firstChild;_.remove(),m.append(..._.childNodes)}for(;(s=Z.nextNode())!==null&&l.length<c;){if(s.nodeType===1){if(s.hasAttributes()){const m=[];for(const _ of s.getAttributeNames())if(_.endsWith("$lit$")||_.startsWith(P)){const I=M[p++];if(m.push(_),I!==void 0){const Y=s.getAttribute(I.toLowerCase()+"$lit$").split(P),k=/([.?@])?(.*)/.exec(I);l.push({type:1,index:r,name:k[2],strings:Y,ctor:k[1]==="."?Gi:k[1]==="?"?$i:k[1]==="@"?ki:de})}else l.push({type:6,index:r})}for(const _ of m)s.removeAttribute(_)}if(It.test(s.tagName)){const m=s.textContent.split(P),_=m.length-1;if(_>0){s.textContent=X?X.emptyScript:"";for(let I=0;I<_;I++)s.append(m[I],te()),Z.nextNode(),l.push({type:2,index:++r});s.append(m[_],te())}}}else if(s.nodeType===8)if(s.data===gt)l.push({type:2,index:r});else{let m=-1;for(;(m=s.data.indexOf(P,m+1))!==-1;)l.push({type:7,index:r}),m+=P.length-1}r++}}static createElement(t,n){const a=W.createElement("template");return a.innerHTML=t,a}}function q(i,t,n=i,a){var s,r,p,c;if(t===K)return t;let l=a!==void 0?(s=n._$Cl)===null||s===void 0?void 0:s[a]:n._$Cu;const u=ie(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==u&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),u===void 0?l=void 0:(l=new u(i),l._$AT(i,n,a)),a!==void 0?((p=(c=n)._$Cl)!==null&&p!==void 0?p:c._$Cl=[])[a]=l:n._$Cu=l),l!==void 0&&(t=q(i,l._$AS(i,t.values),l,a)),t}class Vi{constructor(t,n){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var n;const{el:{content:a},parts:s}=this._$AD,r=((n=t==null?void 0:t.creationScope)!==null&&n!==void 0?n:W).importNode(a,!0);Z.currentNode=r;let p=Z.nextNode(),c=0,l=0,u=s[0];for(;u!==void 0;){if(c===u.index){let M;u.type===2?M=new se(p,p.nextSibling,this,t):u.type===1?M=new u.ctor(p,u.name,u.strings,this,t):u.type===6&&(M=new Qi(p,this,t)),this.v.push(M),u=s[++l]}c!==(u==null?void 0:u.index)&&(p=Z.nextNode(),c++)}return r}m(t){let n=0;for(const a of this.v)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,n),n+=a.strings.length-2):a._$AI(t[n])),n++}}class se{constructor(t,n,a,s){var r;this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=a,this.options=s,this._$Cg=(r=s==null?void 0:s.isConnected)===null||r===void 0||r}get _$AU(){var t,n;return(n=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&n!==void 0?n:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const n=this._$AM;return n!==void 0&&t.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=q(this,t,n),ie(t)?t===N||t==null||t===""?(this._$AH!==N&&this._$AR(),this._$AH=N):t!==this._$AH&&t!==K&&this.$(t):t._$litType$!==void 0?this.T(t):t.nodeType!==void 0?this.k(t):Ui(t)?this.S(t):this.$(t)}A(t,n=this._$AB){return this._$AA.parentNode.insertBefore(t,n)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.A(t))}$(t){this._$AH!==N&&ie(this._$AH)?this._$AA.nextSibling.data=t:this.k(W.createTextNode(t)),this._$AH=t}T(t){var n;const{values:a,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=ae.createElement(s.h,this.options)),s);if(((n=this._$AH)===null||n===void 0?void 0:n._$AD)===r)this._$AH.m(a);else{const p=new Vi(r,this),c=p.p(this.options);p.m(a),this.k(c),this._$AH=p}}_$AC(t){let n=vt.get(t.strings);return n===void 0&&vt.set(t.strings,n=new ae(t)),n}S(t){_t(this._$AH)||(this._$AH=[],this._$AR());const n=this._$AH;let a,s=0;for(const r of t)s===n.length?n.push(a=new se(this.A(te()),this.A(te()),this,this.options)):a=n[s],a._$AI(r),s++;s<n.length&&(this._$AR(a&&a._$AB.nextSibling,s),n.length=s)}_$AR(t=this._$AA.nextSibling,n){var a;for((a=this._$AP)===null||a===void 0||a.call(this,!1,!0,n);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var n;this._$AM===void 0&&(this._$Cg=t,(n=this._$AP)===null||n===void 0||n.call(this,t))}}class de{constructor(t,n,a,s,r){this.type=1,this._$AH=N,this._$AN=void 0,this.element=t,this.name=n,this._$AM=s,this.options=r,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=N}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,n=this,a,s){const r=this.strings;let p=!1;if(r===void 0)t=q(this,t,n,0),p=!ie(t)||t!==this._$AH&&t!==K,p&&(this._$AH=t);else{const c=t;let l,u;for(t=r[0],l=0;l<r.length-1;l++)u=q(this,c[a+l],n,l),u===K&&(u=this._$AH[l]),p||(p=!ie(u)||u!==this._$AH[l]),u===N?t=N:t!==N&&(t+=(u!=null?u:"")+r[l+1]),this._$AH[l]=u}p&&!s&&this.C(t)}C(t){t===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t!=null?t:"")}}class Gi extends de{constructor(){super(...arguments),this.type=3}C(t){this.element[this.name]=t===N?void 0:t}}const Hi=X?X.emptyScript:"";class $i extends de{constructor(){super(...arguments),this.type=4}C(t){t&&t!==N?this.element.setAttribute(this.name,Hi):this.element.removeAttribute(this.name)}}class ki extends de{constructor(t,n,a,s,r){super(t,n,a,s,r),this.type=5}_$AI(t,n=this){var a;if((t=(a=q(this,t,n,0))!==null&&a!==void 0?a:N)===K)return;const s=this._$AH,r=t===N&&s!==N||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,p=t!==N&&(s===N||r);r&&this.element.removeEventListener(this.name,this,s),p&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var n,a;typeof this._$AH=="function"?this._$AH.call((a=(n=this.options)===null||n===void 0?void 0:n.host)!==null&&a!==void 0?a:this.element,t):this._$AH.handleEvent(t)}}class Qi{constructor(t,n,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){q(this,t)}}const Ot=window.litHtmlPolyfillSupport;Ot==null||Ot(ae,se),((we=globalThis.litHtmlVersions)!==null&&we!==void 0?we:globalThis.litHtmlVersions=[]).push("2.2.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var xe,ze;class O extends Q{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,n;const a=super.createRenderRoot();return(t=(n=this.renderOptions).renderBefore)!==null&&t!==void 0||(n.renderBefore=a.firstChild),a}update(t){const n=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=Pi(n,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Dt)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Dt)===null||t===void 0||t.setConnected(!1)}render(){return K}}O.finalized=!0,O._$litElement$=!0,(xe=globalThis.litElementHydrateSupport)===null||xe===void 0||xe.call(globalThis,{LitElement:O});const St=globalThis.litElementPolyfillSupport;St==null||St({LitElement:O}),((ze=globalThis.litElementVersions)!==null&&ze!==void 0?ze:globalThis.litElementVersions=[]).push("3.2.0");const U=C`
:root {
  --bg: #333333;
  --bg-light: #555;
  --color: #eeeeee;
        ...
        <div class="dialog-content">
          <form action="">
            <div class="flex-inline">
              <div class="dialog-text">${a.projectName}</div>
              <input id="serachInput" class="serach-input" type="text" placeholder="${this.lang=="zh"?"\u641C\u7D22":"serach"}" @input="${At(200,!0,n._serach)}">
            </div>
            <span>
...
<div class="dialog-bg d-flex">
  ...
  <div class="search-container ${this.isVisible?"show":"hide"}">
    <div class="search-bar">
      <input ${B(this.searchRef)} class="input-text" type="text" @input="${At(200,!0,n.serach_)}" placeholder="search block">
    </div>
  ...
  .show {
    visibility: visible;
  }`),d($e,"properties",{workspace:{},options:{state:!0},isVisible:{},currIndex:{},selectedBlock:{}}),customElements.define("search-block",$e);class Ct extends O{render(){return E`
  <div class="dialog-bg load8">
    <div class="loader"></div>
  </div>
    `}close(){this.style.display="none"}open(){this.style.display="block"}}d(Ct,"styles",[U,C`
    .load8 .loader,
    .load8 .loader:after {
      border-radius: 50%;
      width: 2rem;
  ...
  `]),customElements.define("loading-screen",Ct);class Rt extends O{render(){const t="https://shop.zjbku.com/product/block3d-license-key/";return E`
  ...
  `),customElements.define("editor-aside",Rt);function w(i){return document.createElement(i)}function sn(i,t){i=typeof i=="string"?document.getElementById("root"):i;const{TITLE:n,PROJECT_NAME:a,LANG:s,PROJECTS_LIST:r,LICENSE_STATUS:p,LICENSE_LEFT_DAYS:c,EXPIRES:l,APP_HOST:u,APP_PORT:M,PROJECTS_FOLDER:m,AUTO_OPEN:_,AUTO_SAVE:I,EXTERNAL_SERVER:Y,VERSION:k,RELEASE_DATE:Za}=t,V=document.body,oe=w("div");oe.className="editor-container",i.appendChild(oe);const pe=w("editor-menu");pe.id="menu",pe.lang=s,pe.name=n,pe.leftdays=c,oe.appendChild(pe);const Ri=w("main");Ri.innerHTML=`
...
It default to 90 degrees to work nicely with the cube texture generation for point lights shadow maps.`],aa=["shadowMaxZ","shadowMaxZ","NUM","10","Sets or gets the shadow projection clipping maximum z value."],sa=["shadowMinZ","shadowMinZ","NUM","1","Sets or gets the shadow projection clipping minimum z value."];L.PointLight=new h([ge,_e,Te,Ee,Ne,Pt,Me,Ie,ve,Yt]),L.DirectionalLight=new h([ge,_e,Te,Ee,Ne,Pt,Me,Ie,ve,["shadowFrustumSize","shadowFrustumSize","NUM","10","Fix frustum size for the shadow generation. This is disabled if the value is 0."],["shadowOrthoScale","shadowOrthoScale","NUM","0.1","Sets or gets the shadow projection scale against the optimal computed one. 0.1 by default which means that the projection window is increase by 10% from the optimal size. This does not impact in fixed frustum size (shadowFrustumSize being set)"]]),L.SpotLight=new h([ge,_e,Te,Ee,["innerAngle","innerAngle","NUM","1","Only used in gltf falloff mode, this defines the angle where the directional falloff will start before cutting at angle which could be seen as outer angle."],Ne,Me,Ie,Yt,ve,aa,sa]),L.HemisphericLight=new h([ge,_e,Te,Ee,Ne,Me,Ie,ve]),L.shadow=new h([["bias","bias","NUM","0","Sets the bias: offset applied on the depth preventing acnea (in light direction)."],["blurBoxOffset","blurBoxOffset","NUM","0",`Sets the blur box offset: offset applied during the blur pass.
...
function ${e.JavaScript.FUNCTION_NAME_PLACEHOLDER_}(option, point_option, normal_option){ 
  ...
  ${t}.moveToVector3(${n}, appInstance.scene);`:""};const oi=`
  // common function
