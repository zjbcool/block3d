<template><h1 id="选项卡" tabindex="-1"><a class="header-anchor" href="#选项卡" aria-hidden="true">#</a> 选项卡</h1>
<nav class="table-of-contents"><ul><li><RouterLink to="#基本操作">基本操作</RouterLink></li><li><RouterLink to="#拼图编辑器和代码编辑器">拼图编辑器和代码编辑器</RouterLink></li><li><RouterLink to="#执行选项卡">执行选项卡</RouterLink></li><li><RouterLink to="#跳转选项卡">跳转选项卡</RouterLink></li><li><RouterLink to="#选项卡内部变量">选项卡内部变量</RouterLink></li><li><RouterLink to="#跨选项卡通信">跨选项卡通信</RouterLink><ul><li><RouterLink to="#选项卡参数">选项卡参数</RouterLink></li><li><RouterLink to="#全局对象">全局对象</RouterLink></li></ul></li></ul></nav>
<p>选项卡区域位于编辑区和视图区的中间，它的右侧边缘是可拖拽的，用来改变两侧区域的大小。</p>
<p>选项卡可以作为一组实现特定功能的拼图或代码的容器，允许嵌套。</p>
<h2 id="基本操作" tabindex="-1"><a class="header-anchor" href="#基本操作" aria-hidden="true">#</a> 基本操作</h2>
<p>除了默认选项卡<code v-pre>main</code>是不可修改的，用户可以通过菜单栏-<code v-pre>下拉菜单</code>-<code v-pre>选项卡</code>下的命令对选项卡执行新建、删除、重命名操作。</p>
<p>还可以通过选项卡下方的<code v-pre>+</code> <code v-pre>-</code>按钮，执行新建和删除操作。</p>
<p><img src="https://cdn.zjbku.com/diving-deeper/tab-1.jpg" alt="tab-1"></p>
<h2 id="拼图编辑器和代码编辑器" tabindex="-1"><a class="header-anchor" href="#拼图编辑器和代码编辑器" aria-hidden="true">#</a> 拼图编辑器和代码编辑器</h2>
<p>点击选项卡下方的<code v-pre>+</code>按钮，打开<code v-pre>新建选项卡</code>对话框，在<code v-pre>编辑器类型</code>中有拼图和代码2种类型的编辑器可选。</p>
<p><img src="https://cdn.zjbku.com/diving-deeper/create-tab-dialog.jpg" alt="create-tab-dialog"></p>
<p>拼图编辑器是我们以后最常使用的编辑器。如果没有特别说明，编辑器就是指拼图编辑器。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="执行选项卡" tabindex="-1"><a class="header-anchor" href="#执行选项卡" aria-hidden="true">#</a> 执行选项卡</h2>
<p>选项卡中，除了默认的<code v-pre>main</code>选项卡是自动执行的，用户自行创建的选项卡需要使用<code v-pre>系统 System</code>分类下的<RouterLink to="/block3d/blocks-reference/system.html#execute-tab">excute_tab</RouterLink>拼图指定要执行的选项卡。这样做的好处是，用户可以完全控制选项卡的执行时机。</p>
...
<h2 id="跳转选项卡" tabindex="-1"><a class="header-anchor" href="#跳转选项卡" aria-hidden="true">#</a> 跳转选项卡</h2>
...
<h2 id="选项卡内部变量" tabindex="-1"><a class="header-anchor" href="#选项卡内部变量" aria-hidden="true">#</a> 选项卡内部变量</h2>
...
<h2 id="跨选项卡通信" tabindex="-1"><a class="header-anchor" href="#跨选项卡通信" aria-hidden="true">#</a> 跨选项卡通信</h2>
...
<h3 id="选项卡参数" tabindex="-1"><a class="header-anchor" href="#选项卡参数" aria-hidden="true">#</a> 选项卡参数</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="全局对象" tabindex="-1"><a class="header-anchor" href="#全局对象" aria-hidden="true">#</a> 全局对象</h3>
